...
class CaptionGenerator(object):
    ...
    def build_model(self):
       ...
       # mask = tf.to_int32(tf.not_equal(captions_out, self._null))
        ...
        for t in range(self.T):
            ...
            loss += tf.reduce_sum(tf.nn.sparse_softmax_cross_entropy_with_logits(labels =labels,logits=logits)*mask[:, t])
